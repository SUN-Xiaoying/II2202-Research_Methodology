...
# labs(
#     title="Throughput of various Hashing algorithms when num_requests=10000", 
#     x="The number of servers", 
#     y ="Throuhput (million ops/s)")
# # scale_color_manual(values = c("darkred", "steelblue"))
# ggsave("./results/throughput/all_th_command=10000.png", p, width=9.5)


png("./results/throughput/all_th_command=10000.png",width=700)
plot(
    x=x,
    y=ch,
    main="Throughput of various Hashing when num_requests=10000", 
    xlab="The number of servers", 
