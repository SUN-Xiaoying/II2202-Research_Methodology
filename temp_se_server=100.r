...
df1 <- read.table(file="./throughput/jump_hashing.csv", sep="\t", header=TRUE)
...
png("./results/se/jump_se_server=100.png",width=750)
plot(
    0,0,
    main="Standard Error of Jump Hashing when server=100",
